...
- [X] T084 [US4] Add container runtime detection to support both Podman and Docker in src/cli/main.py
- [X] T085 [US4] Add PROVISIONING_AUTO_INSTALL_ANSIBLE config option to auto-install Ansible in containers
- [X] T086 [US4] Create bootstrap playbook in ansible/bootstrap.yml for Ansible auto-installation
- [X] T087 [US4] Implement infra-agnostic provisioning that works with VMs (libvirt, VirtualBox), Podman, and Docker
- [X] T088 [US4] Add validation for PROVISIONING_AUTO_INSTALL_ANSIBLE config option in config parser
- [X] T089 [US4] Create integration tests for container runtime detection and auto-install functionality
